...
export default function WhatsAppFloat() {
  const message = encodeURIComponent('Hello Vellore Enterprises! I need assistance with fire safety solutions.');
  return (
    <a
      href={`https://wa.me/918072264972?text=${message}`}
      target="_blank"
      rel="noopener noreferrer"
      className="whatsapp-float"
      aria-label="Contact Vellore Enterprises on WhatsApp"
    >
