...
export default function WhatsAppFloat() {
  const href = buildWhatsAppUrl('Hello Vellore Enterprises! I need assistance with fire safety solutions.');
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="whatsapp-float" aria-label="Contact Vellore Enterprises on WhatsApp">
